    ...
    <section className="relative h-[700px] w-full flex items-end overflow-hidden">
     ...
     <div
      ...
      style={{
       ...
       backgroundImage: "linear-gradient(rgba(89, 66, 123, 0.6), rgba(89, 66, 123, 0.6)), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&h=600&fit=crop')"
      }}
     />
     <HeroText
