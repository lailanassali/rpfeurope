...
export const metadata: Metadata = {
	...
	description:
		"Join RPF Europe - a globally expanding Pentecostal movement raising purposeful followers for Christ. Experience transformative worship, fellowship, and spiritual growth across our UK branches.",
	keywords: [
	...
	return (
		<div className="w-full flex min-h-screen flex-col font-sans">
			<main className="flex-1">
				...
				<section
					className="relative pt-12 md:pt-16 lg:pt-[96px] pb-24 md:pb-32 lg:pb-[194px]"
					style={{ backgroundColor: "#CEC3DF40" }}
				>
					<div className="">
					...
					<div className="container w-full px-4 sm:w-11/12 mx-auto">
						<div className="max-w-full mx-auto bg-[#7F4A19] text-white rounded-lg md:rounded-2xl py-8 md:py-12 lg:py-[76px] px-6 md:px-8 lg:px-[48px] text-center shadow-xl">
							<p className="text-xl md:text-2xl lg:text-[36px] leading-relaxed">
								"We are committed to raising up zealous believers who walk
								boldly in their God-given callings and carry the presence of God
								wherever they go."
							</p>
						</div>
					</div>
