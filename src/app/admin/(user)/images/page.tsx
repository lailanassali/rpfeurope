...
const PAGE_OPTIONS = [
	...
	{
		value: "ministries_carousel",
		label: "Home - Ministries Carousel",
		isCarousel: true,
	},
	...
	{
		value: "youth_place_belong",
		label: "Youth - Place to Belong",
		isCarousel: false,
	},
	{
		value: "youth_rooted_faith",
		label: "Youth - Rooted in Faith",
		isCarousel: false,
	},
	{
		value: "youth_meet_grow",
		label: "Youth - Where We Meet",
		isCarousel: false,
	},
	{
		value: "youth_leadership",
		label: "Youth - Leadership (Pastor Reece)",
		isCarousel: false,
	},
	...
	// Fellowship Ministry
	{
		value: "fellowship_hero",
		label: "Fellowship - Hero Section",
		isCarousel: false,
	},
	{
		value: "fellowship_worship",
		label: "Fellowship - Worship With Us",
		isCarousel: false,
	},
	{
		value: "fellowship_cta",
		label: "Fellowship - Final CTA",
		isCarousel: false,
	},
	...
	{
		value: "children_hero",
		label: "Children - Hero Section",
		isCarousel: false,
	},
	{
		value: "children_activities",
		label: "Children - Image Grid (4 Images)",
		isCarousel: true,
	},
	{
		value: "children_faith",
		label: "Children - Building Faith",
		isCarousel: false,
	},
	{
		value: "children_family",
		label: "Children - Part of Family",
		isCarousel: false,
	},
	{
		value: "children_place",
		label: "Children - Place for Every Child",
		isCarousel: false,
	},
	...
	// University Ministry
	{
		value: "university_hero",
		label: "University - Hero Section",
		isCarousel: false,
	},
	{
		value: "university_home",
		label: "University - Home on Campus",
		isCarousel: false,
	},
	{
		value: "university_cta",
		label: "University - Final CTA",
		isCarousel: false,
	},
	...
	{
		value: "about_leadership",
		label: "About - Leadership (Pastor E-Ben)",
		isCarousel: false,
	},
	{
		value: "about_sunday",
		label: "About - Sunday Service Card",
		isCarousel: false,
	},
	{
		value: "about_bible",
		label: "About - Bible Study Card",
		isCarousel: false,
	},
	{
		value: "about_firenight",
		label: "About - Fire Night Card",
		isCarousel: false,
	},
	...
	// Connect Page Tabs
	{
		value: "connect_baptism",
		label: "Connect - Baptism Tab",
		isCarousel: false,
	},
	{
		value: "connect_counselling",
		label: "Connect - Counselling Tab",
		isCarousel: false,
	},
	{
		value: "connect_mentorship",
		label: "Connect - Mentorship Tab",
		isCarousel: false,
	},
	{ value: "connect_serve", label: "Connect - Serve Tab", isCarousel: false },
	{
		value: "connect_testimonies",
		label: "Connect - Testimonies Tab",
		isCarousel: false,
	},
	...
	// Give Life Page
	{
		value: "give_life_carousel",
		label: "Give Life - Bottom Carousel",
		isCarousel: true,
	},
	...
	// Join Service Page
	{
		value: "join_service_hero",
		label: "Join Service - Hero Section",
		isCarousel: false,
	},
	{
		value: "join_service_cta",
		label: "Join Service - Final CTA",
		isCarousel: false,
	},
];
...
export default function ImagesPage() {
	...
	async function handleUpload(urlOverride?: string) {
		const urlToUse =
			typeof urlOverride === "string" ? urlOverride : newImageUrl;
		...
		try {
			...
			toast.success(
				isCarousel ? "Image added to carousel" : "Page image updated",
			);
			setNewImageUrl("");
			fetchImages();
		} catch (error) {
	...
	async function handleDelete() {
		...
		setIsDeleting(true);
		try {
			const res = await fetch(`/api/admin/images/${deleteId}`, {
				method: "DELETE",
			});
			if (!res.ok) throw new Error();
		...
		<div>
			...
			<div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
				<h3 className="font-semibold mb-4 capitalize">
					Select A Page You want to add image to
				</h3>
				<FormSelect
					label=""
					value={selectedPage}
					onChange={(e) => setSelectedPage(e.target.value)}
					options={PAGE_OPTIONS.map((p) => ({
						value: p.value,
						label: p.label,
					}))}
				/>
				<p className="text-sm text-gray-600 mt-2">
					{isCarousel
						? "📸 Carousel - You can add multiple images"
						: "🖼 Single Image - Uploading will replace existing image"}
				</p>
			</div>
			...
			<div className="bg-white rounded-lg shadow-sm border p-6">
				<h3 className="font-semibold mb-4">
					Current {isCarousel ? "Carousel Images" : "Image"}
				</h3>
				{images.length === 0 ? (
