...
export const metadata: Metadata = {
 title: "About Us | CHH Europe",
 description: "Learn about our mission, vision, and leadership at Christ Healing Home Europe.",
};
 ...
 return (
  <div className="flex min-h-screen flex-col">
   <main className="flex-1">
    ...
    <section className="container w-11/12 mx-auto px-4 pt-16">
     <h1 className="text-[36px] text-primary font-normal mb-[72px] text-center">
    ...
    <section className="container w-11/12 mx-auto px-4 mt-20 mb-20">
     <SectionContent
      heading="Our Story"
    ...
    <section className="bg-white py-24 mb-20">
     <div className="container w-11/12 mx-auto px-4">
      ...
      <div className="flex gap-12 items-start flex-row-reverse">
       {/* Image - 45% */}
       <div className="w-[45%]">
      ...
      items={[
       {
        ...
        image: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=800&h=1000&fit=crop"
       },
       {
        ...
        image: "https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?w=800&h=1000&fit=crop"
       },
       {
        ...
        image: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=800&h=1000&fit=crop"
       }
      ]}
     />
    </section>
    ...
    <section className="container w-11/12 mx-auto px-4 mb-24">
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <LocationCard
       ...
       image="https://images.unsplash.com/photo-1507692049790-de58290a4334?w=600&h=900&fit=crop"
       href="/events"
      />
      <LocationCard
       location="Bible Study"
       image="https://images.unsplash.com/photo-1519491050282-cf00c82424b4?w=600&h=900&fit=crop"
       href="/events"
      />
      <LocationCard
       location="Fire Night"
       image="https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=600&h=900&fit=crop"
       href="/events"
      />
     </div>
    </section>
