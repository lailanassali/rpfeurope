...
export function GiveLifeForm() {
 ...
 return (
  <div className="lg:w-1/2 md:px-[48px] py-8 rounded-[16px] md:border border-[#e5e5e5]/50 mx-auto">
   <div className="">
    <h3 className="text-[24px] font-semibold text-[#211F1F] mt-6 mb-8 text-center">
